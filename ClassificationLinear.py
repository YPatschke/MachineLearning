...
for j in range(1,timestep+1):
    ...
    for i in range(0, num_user):
        ...
        plt.savefig('C:/Users/Yannick/Desktop/Image1/Linear/user'+str(i)+'Timestep'+str(j)+'Loss.png')
        plt.close(fig)
        ...
        plt.savefig('C:/Users/Yannick/Desktop/Image1/Linear/user'+str(i)+'Timestep'+str(j)+'Accuracy.png')
        plt.close(fig)
...
for i in range(0, num_user):
    ...
    plt.savefig('C:/Users/Yannick/Desktop/Image1/Linear/user'+str(i)+'Accuracy2.png')
    plt.close(fig)
